...
extern "C" {
	...
	Result_void cv_ccalib_CustomPattern_getPatternPoints_vector_KeyPoint_X(cv::ccalib::CustomPattern* instance, std::vector<cv::KeyPoint>* original_points) {
		try {
	...
	Result<bool> cv_ccalib_CustomPattern_findRt_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputOutputArrayX_const__InputOutputArrayX_bool_int(cv::ccalib::CustomPattern* instance, const cv::_InputArray* image, const cv::_InputArray* cameraMatrix, const cv::_InputArray* distCoeffs, const cv::_InputOutputArray* rvec, const cv::_InputOutputArray* tvec, bool useExtrinsicGuess, int flags) {
		try {
	...
	Result_void cv_randpattern_RandomPatternCornerFinder_loadPattern_const_MatX(cv::randpattern::RandomPatternCornerFinder* instance, const cv::Mat* patternImage) {
		try {
	...
	Result_void cv_randpattern_RandomPatternCornerFinder_loadPattern_const_MatX_const_vector_KeyPoint_X_const_MatX(cv::randpattern::RandomPatternCornerFinder* instance, const cv::Mat* patternImage, const std::vector<cv::KeyPoint>* patternKeyPoints, const cv::Mat* patternDescriptors) {
		try {
