...
extern "C" {
	...
	Result<double> cv_calibrateCameraRO_const__InputArrayX_const__InputArrayX_Size_int_const__InputOutputArrayX_const__InputOutputArrayX_const__OutputArrayX_const__OutputArrayX_const__OutputArrayX_int_TermCriteria(const cv::_InputArray* objectPoints, const cv::_InputArray* imagePoints, const cv::Size* imageSize, int iFixedPoint, const cv::_InputOutputArray* cameraMatrix, const cv::_InputOutputArray* distCoeffs, const cv::_OutputArray* rvecs, const cv::_OutputArray* tvecs, const cv::_OutputArray* newObjPoints, int flags, const cv::TermCriteria* criteria) {
		try {
	...
	Result_void cv_calibrationMatrixValues_const__InputArrayX_Size_double_double_doubleX_doubleX_doubleX_Point2dX_doubleX(const cv::_InputArray* cameraMatrix, const cv::Size* imageSize, double apertureWidth, double apertureHeight, double* fovx, double* fovy, double* focalLength, cv::Point2d* principalPoint, double* aspectRatio) {
		try {
	...
	Result<bool> cv_checkChessboard_const__InputArrayX_Size(const cv::_InputArray* img, const cv::Size* size) {
		try {
	...
	Result<cv::Mat*> cv_getDefaultNewCameraMatrix_const__InputArrayX_Size_bool(const cv::_InputArray* cameraMatrix, const cv::Size* imgsize, bool centerPrincipalPoint) {
		try {
	...
	Result_void cv_initUndistortRectifyMap_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_Size_int_const__OutputArrayX_const__OutputArrayX(const cv::_InputArray* cameraMatrix, const cv::_InputArray* distCoeffs, const cv::_InputArray* R, const cv::_InputArray* newCameraMatrix, const cv::Size* size, int m1type, const cv::_OutputArray* map1, const cv::_OutputArray* map2) {
		try {
	...
	Result<float> cv_initWideAngleProjMap_const__InputArrayX_const__InputArrayX_Size_int_int_const__OutputArrayX_const__OutputArrayX_UndistortTypes_double(const cv::_InputArray* cameraMatrix, const cv::_InputArray* distCoeffs, const cv::Size* imageSize, int destImageWidth, int m1type, const cv::_OutputArray* map1, const cv::_OutputArray* map2, cv::UndistortTypes projType, double alpha) {
		try {
	...
	Result_void cv_undistortPoints_const__InputArrayX_const__OutputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX_TermCriteria(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::_InputArray* cameraMatrix, const cv::_InputArray* distCoeffs, const cv::_InputArray* R, const cv::_InputArray* P, const cv::TermCriteria* criteria) {
		try {
	...
	Result_void cv_undistort_const__InputArrayX_const__OutputArrayX_const__InputArrayX_const__InputArrayX_const__InputArrayX(const cv::_InputArray* src, const cv::_OutputArray* dst, const cv::_InputArray* cameraMatrix, const cv::_InputArray* distCoeffs, const cv::_InputArray* newCameraMatrix) {
		try {
	...
	Result<int> cv_LMSolver_run_const_const__InputOutputArrayX(const cv::LMSolver* instance, const cv::_InputOutputArray* param) {
		try {
	...
	Result<cv::Ptr<cv::LMSolver>*> cv_LMSolver_create_const_Ptr_Callback_X_int(const cv::Ptr<cv::LMSolver::Callback>* cb, int maxIters) {
		try {
			cv::Ptr<cv::LMSolver> ret = cv::LMSolver::create(*cb, maxIters);
			return Ok(new cv::Ptr<cv::LMSolver>(ret));
		} OCVRS_CATCH(Result<cv::Ptr<cv::LMSolver>*>)
	}
	
	Result<cv::Ptr<cv::LMSolver>*> cv_LMSolver_create_const_Ptr_Callback_X_int_double(const cv::Ptr<cv::LMSolver::Callback>* cb, int maxIters, double eps) {
		try {
	...
	Result<bool> cv_LMSolver_Callback_compute_const_const__InputArrayX_const__OutputArrayX_const__OutputArrayX(const cv::LMSolver::Callback* instance, const cv::_InputArray* param, const cv::_OutputArray* err, const cv::_OutputArray* J) {
		try {
	...
	Result<cv::Ptr<cv::StereoBM>*> cv_StereoBM_create_int_int(int numDisparities, int blockSize) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::StereoBM>*>)
	}
	...
	Result<cv::Ptr<cv::StereoSGBM>*> cv_StereoSGBM_create_int_int_int_int_int_int_int_int_int_int_int(int minDisparity, int numDisparities, int blockSize, int P1, int P2, int disp12MaxDiff, int preFilterCap, int uniquenessRatio, int speckleWindowSize, int speckleRange, int mode) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::StereoSGBM>*>)
	}
